...
export const SLOT_POSITIONS = [
  ...
  // Left side - Top bracket slot (SF slot)
  ...
  // Left side - Bottom bracket slot (SF slot)
  ...
  // Right side - Top bracket slot (SF slot)
  ...
  // Right side - Bottom bracket slot (SF slot)
...
export const MATCHES = {
  // Quarter Finals
  qf0: { players: [0, 1], bracketSlot: 2 },
  qf1: { players: [3, 4], bracketSlot: 5 },
  qf2: { players: [6, 7], bracketSlot: 8 },
  qf3: { players: [9, 10], bracketSlot: 11 },

  // Semi Finals
  sf0: { players: [2, 5], bracketSlot: 'final0' },
  sf1: { players: [8, 11], bracketSlot: 'final1' },
};
